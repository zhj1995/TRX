...
export default {
  ...
  data(){
    return{
      ...
      loading:true,
      //要获取的值
      getData:'get_pw_user_group',
      //创建地址
      Createsrc:"http://localhost/TRX/api/pw_user_group/Addgroup",
      //更新地址
      Editsrc:"http://localhost/TRX/api/pw_user_group/update",
      //删除地址
      Deletesrc:"http://localhost/TRX/api/pw_user_group/Delete/",
      //删除提供的id
      U_id:'group_code'
    }
  },
  methods:{
    ...
    loadingdata(){
      ...
      //获取容器表
      this.$store.dispatch('get_pw_user_group',this.current_group_role);
      var _this = this;
